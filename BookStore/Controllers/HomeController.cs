...
namespace BookStore.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ViewResult> Index()
        {
            ...
            //this code done here for testing perpose but used this code to send an email to verify user. in sendemailconfirmationmail method in accountreposty file. code is till await line
